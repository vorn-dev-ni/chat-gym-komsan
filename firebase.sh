...
case $1 in
  dev)
    flutterfire config \
      ...
      --out="/lib/utils/firebase_options_dev.dart" \
      --ios-bundle-id=com.example.demo.dev \
      --ios-out="$ROOT_DIR/ios/flavors/dev/GoogleService-Info.plist" \
  ...
  staging)
    flutterfire config \
      ...
      --ios-out="$ROOT_DIR/ios/flavors/staging/GoogleService-Info.plist" \
  ...
  prod)
    flutterfire config \
      ...
      --ios-out="$ROOT_DIR/ios/flavors/prod/GoogleService-Info.plist" \
